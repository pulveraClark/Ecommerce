        ...
        <div class="w-full px-4 md:w-1/2">
          <div class="lg:pl-20">
            <div class="mb-8 [&>ul]:list-disc [&>ul]:pl-5 [&>ul]:ml-4">
              <h2 class="max-w-xl mb-6 text-2xl font-bold md:text-4xl">{{ $product->name }}</h2>
            ...
            <div class="flex flex-wrap gap-4 mt-4">
              <!-- Add to Cart -->
              <button wire:click='addToCart({{ $product->id }})' class="flex-1 p-4 bg-blue-500 rounded-md text-gray-50 font-semibold hover:bg-blue-600 transition-colors duration-200">
