      ...
      <div>
        ...
        <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200">
          ...
          <div class="w-full px-4 mb-4 md:w-1/4">
            ...
            <p class="text-base font-semibold leading-4 text-gray-800">{{ $order->created_at->format('m-d-Y')}}</p>
          </div>
          <div class="w-full px-4 mb-4 md:w-1/4">
            <p class="mb-2 text-sm font-medium leading-5 text-gray-800">Total:</p>
            <p class="text-base font-semibold leading-4 text-blue-600">{{ Number::currency($order->grand_total) }}</p>
          </div>
          <div class="w-full px-4 mb-4 md:w-1/4">
          ...
          <div class="flex flex-col items-stretch justify-center w-full space-y-4 md:flex-row md:space-y-0 md:space-x-8">
            <div class="flex flex-col w-full space-y-6">
              ...
              <div class="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200">
                <div class="flex justify-between w-full">
                  ...
                  <p class="text-base leading-4 text-gray-600">{{ Number::currency($order->grand_total) }}</p>
                </div>
                <div class="flex items-center justify-between w-full">
                  <p class="text-base leading-4 text-gray-800">Discount</p>
                  <p class="text-base leading-4 text-gray-600">{{ Number::currency(0) }}</p>
                </div>
                <div class="flex items-center justify-between w-full">
              ...
              <div class="flex items-center justify-between w-full">
                ...
                <p class="text-base font-semibold leading-4 text-gray-600">{{ Number::currency($order->grand_total) }}</p>
              </div>
            </div>
            ...
            <div class="flex flex-col w-full px-2 space-y-4 md:px-8">
              ...
              <div class="flex items-start justify-between w-full">
                ...
                <p class="text-lg font-semibold leading-6 text-gray-800">{{ Number::currency(0) }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex items-center justify-start gap-4 px-4 mt-6">
          ...
          <a href="/my-orders" class="w-full text-center px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-auto hover:bg-blue-600">
            View My Orders
          </a>
        </div>
      </div>
