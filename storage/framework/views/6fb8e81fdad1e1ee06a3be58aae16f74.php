...
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <!-- Error Text -->
                    <p class="text-red-600 mt-2" id="password-confirmation-error"><?php echo e($message); ?></p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH C:\Users\Administrator\Ecommerce\resources\views/livewire/auth/reset-password-page.blade.php ENDPATH**/ ?>