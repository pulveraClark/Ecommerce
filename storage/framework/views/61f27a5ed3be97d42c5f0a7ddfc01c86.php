        ...
        <div class="flex-1 max-w-6xl px-4 py-6 mx-auto bg-white border rounded-md md:py-10 md:px-10">
            ...
            <div class="border-b border-gray-200 px-4 mb-8 pb-6">
                ...
                <div class="space-y-1 text-gray-700">
                    <p class="font-semibold text-lg">
                        <?php echo e($order->address->first_name); ?> <?php echo e($order->address->last_name); ?>

                    </p>

                    <p><?php echo e($order->address->street_address); ?></p>
                    <p><?php echo e($order->address->city); ?>, <?php echo e($order->address->state); ?> <?php echo e($order->address->zip_code); ?></p>
                    <p>Phone: <?php echo e($order->address->phone); ?></p>
                </div>
            </div>
            ...
            <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200">
                ...
                <div class="w-full px-4 mb-4 md:w-1/4">
                    ...
                    <p class="text-base font-semibold text-gray-800"><?php echo e($order->id); ?></p>
                </div>
                ...
                <div class="w-full px-4 mb-4 md:w-1/4">
                    ...
                    <p class="text-base font-semibold text-blue-600">
                        <?php echo e(Number::currency($order->grand_total)); ?>
                ...
                <div class="w-full px-4 mb-4 md:w-1/4">
                    ...
                    <p class="text-base font-semibold text-gray-800">
                        <?php echo e($order->payment_method == 'cod' ? 'Cash On Delivery' : 'Card'); ?>
                    ...
                    <div class="flex-1 space-y-6">
                        ...
                        <div class="border-b border-gray-200 pb-4 space-y-4">
                            ...
                            <div class="flex justify-between">
                                ...
                                <p class="text-gray-600"><?php echo e(Number::currency($subtotal)); ?></p>
                            </div>

                            <div class="flex justify-between">
                                <p class="text-gray-800">Discount <!--[if BLOCK]><![endif]--><?php if($order->coupon_used): ?> (<?php echo e($order->coupon_used); ?>) <?php endif; ?><!--[if ENDBLOCK]><![endif]--></p>
                                <p class="text-gray-600">-<?php echo e(Number::currency($order->discount_amount)); ?></p>
                            </div>
                        ...
                        <div class="flex justify-between font-semibold text-gray-800">
                            <p>Total</p>
                            <p><?php echo e(Number::currency($order->grand_total)); ?></p>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\Administrator\Ecommerce\resources\views/livewire/success-page.blade.php ENDPATH**/ ?>