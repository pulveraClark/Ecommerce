					...
					<div class="mb-6">
						...
						<div class="grid grid-cols-2 gap-4">
							<div>
								...
								<input wire:model='first_name' class="w-full rounded-lg border py-2 px-3 <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
							...
							<div>
								...
								<input wire:model='last_name' class="w-full rounded-lg border py-2 px-3 <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
						...
						<div class="mt-4">
							...
							<input wire:model='phone' class="w-full rounded-lg border py-2 px-3 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
						...
						<div class="mt-4">
							...
							<input wire:model='street_address' class="w-full rounded-lg border py-2 px-3 <?php $__errorArgs = ['street_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
						...
						<div class="mt-4">
							...
							<input wire:model='city' class="w-full rounded-lg border py-2 px-3 <?php $__errorArgs = ['city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							<div>
								...
								<input wire:model='state' class="w-full rounded-lg border py-2 px-3 <?php $__errorArgs = ['state'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
							...
							<div>
								...
								<input wire:model='zip_code' class="w-full rounded-lg border py-2 px-3 <?php $__errorArgs = ['zip_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
							...
							<li class="py-3 sm:py-4" wire:key='<?php echo e($ci['product_id']); ?>'>
								<div class="flex items-center">
									<div class="flex-shrink-0">
										<img alt="<?php echo e($ci['name']); ?>" class="w-12 h-12 rounded-full" src="<?php echo e(url('storage', $ci['image'])); ?>">
									</div>
									<div class="flex-1 min-w-0 ms-4">
										<p class="text-sm font-medium text-gray-900 truncate"><?php echo e($ci['name']); ?></p>
										<p class="text-sm text-gray-500 truncate">Quantity: <?php echo e($ci['quantity']); ?></p>
									</div>
									<div class="inline-flex items-center text-base font-semibold text-gray-900">
										<?php echo e(Number::currency($ci['total_amount'], 'USD')); ?>
...
<?php /**PATH C:\Users\Administrator\Ecommerce\resources\views/livewire/checkout-page.blade.php ENDPATH**/ ?>